...
As a first task, you've been asked to analyze the district-wide standardized test results. You'll be given access to every student's math and reading scores, as well as various information on the schools they attend. Using the data provided schools_complete.csv and students_compelte.csv, I was responsible to aggregate the data to and showcase obvious trends in school performance.
